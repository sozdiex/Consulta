            ...
            dispatch_async(dispatch_get_main_queue(), {
                ...
                if (dic.objectForKey("sn_accesoCorrecto")?.boolValue != nil) {
                    if (dic.objectForKey("sn_accesoCorrecto") as! Bool) {
                        ...
                        NSUserDefaults.standardUserDefaults().setObject(dic.objectForKey("sn_administrador"), forKey: "sn_administrador")
                        NSUserDefaults.standardUserDefaults().setObject(dic.objectForKey("sn_consulta"), forKey: "sn_consulta")

                        //NSUserDefaults.standardUserDefaults().setObject(false, forKey: "sn_administrador")
                        //NSUserDefaults.standardUserDefaults().setObject(false, forKey: "sn_consulta")

                        
                        let root = self.storyboard?.instantiateViewControllerWithIdentifier("RootViewController") as? RootViewController
